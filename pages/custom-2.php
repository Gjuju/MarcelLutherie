...
//echo 'part Options : <br>'; 
    foreach($_POST as $key => $value) {
        if ($key !== 'projet'){
            ...
            $sqlopt = 'SELECT options.nom_opt as opt_nom FROM options JOIN categorie ON options.id_cat=categorie.id WHERE options.id_cat = '. $id_cat .' AND options.prix = '. $surcout .' ;';
                        ...
                        <div class="row  mt-5 text-center">
                            ...
                            <div class="col-4">
                                ...
                                if (isset($_SESSION['prenom'])) {
                                    echo '<button type="submit" class="btn btn-success" name="projet" value="<?php echo $idproduit ?>">Valider</button>';
                                } else {
